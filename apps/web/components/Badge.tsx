...
export default function Badge({ tier, size = 'md' }: BadgeProps) {
    ...
    const tierStyles = {
        ...
        offChipter:
            'bg-linear-to-br from-hot-orange to-chip-yellow text-almost-black border-almost-black',
    };
    ...
    return (
        <span
            className={`inline-block font-mono font-bold uppercase tracking-wider border-[3px] ${sizeClasses[size]} ${tierStyles[tier]}`}
        >
            {tierLabels[tier]}
        </span>
    );
