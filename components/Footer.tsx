        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="font-sans text-sm text-warm-white/80 mb-4">
              Professional chip criticism since 2024. We rate chips on a seismic scale because snacks deserve scrutiny.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/reviews" className="font-sans text-sm text-warm-white/80 hover:text-hot-orange transition-colors">
                  All Reviews
                </Link>
              </li>
              <li>
                <Link href="/badges" className="font-sans text-sm text-warm-white/80 hover:text-hot-orange transition-colors">
                  Badge Gallery
                </Link>
              </li>
              <li>
                <Link href="/methodology" className="font-sans text-sm text-warm-white/80 hover:text-hot-orange transition-colors">
                  Review Methodology
                </Link>
              </li>
              <li>
                <Link href="/submit" className="font-sans text-sm text-warm-white/80 hover:text-hot-orange transition-colors">
                  Submit a Chip
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t-[3px] border-warm-white/20 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link href="/privacy" className="font-mono text-xs uppercase tracking-wider text-warm-white/60 hover:text-hot-orange transition-colors">
                PRIVACY
              </Link>
              <Link href="/terms" className="font-mono text-xs uppercase tracking-wider text-warm-white/60 hover:text-hot-orange transition-colors">
                TERMS
              </Link>
              <Link href="/sitemap" className="font-mono text-xs uppercase tracking-wider text-warm-white/60 hover:text-hot-orange transition-colors">
                SITEMAP
              </Link>
            </div>
          </div>
