...
export default function ChipterScale() {
  ...
  const scalePoints = [
    ...
    { value: 10, label: 'OFF CHIPTER', color: 'bg-linear-to-r from-hot-orange to-chip-yellow' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          {criteria.map((criterion) => (
            ...
            >
              ...
              <p className={`font-sans text-xs text-gray transition-all duration-200 ${
                hoveredCriteria === criterion.name ? 'opacity-100' : 'opacity-0 h-0'
              }`}>
          ...
          <div className="bg-warm-white border-[3px] border-almost-black p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                <div className="font-mono font-bold text-lg text-hot-orange min-w-[60px]">7.0+</div>
                <div className="h-[3px] flex-1 bg-chip-yellow"></div>
                <div className="font-mono font-bold uppercase tracking-wider text-sm">SEISMIC SNACK</div>
              </div>
              <div className="flex items-center gap-4">
                <div className="font-mono font-bold text-lg text-hot-orange min-w-[60px]">8.0+</div>
                <div className="h-[3px] flex-1 bg-hot-orange"></div>
                <div className="font-mono font-bold uppercase tracking-wider text-sm">TECTONIC CRUNCH</div>
              </div>
              <div className="flex items-center gap-4">
                <div className="font-mono font-bold text-lg text-hot-orange min-w-[60px]">9.0+</div>
                <div className="h-[3px] flex-1 bg-almost-black"></div>
                <div className="font-mono font-bold uppercase tracking-wider text-sm">EPICENTER ELITE</div>
              </div>
              <div className="flex items-center gap-4">
                <div className="font-mono font-bold text-lg text-hot-orange min-w-[60px]">10.0</div>
                <div className="h-[3px] flex-1 bg-linear-to-r from-hot-orange to-chip-yellow"></div>
                <div className="font-mono font-bold uppercase tracking-wider text-sm">OFF THE CHIPTER</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-warm-white border-[3px] border-almost-black p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="font-mono font-bold text-sm uppercase">AVERAGE CHIP</span>
                <span className="font-mono font-extrabold text-lg text-hot-orange">5.8</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-mono font-bold text-sm uppercase">CHIPS ABOVE 7.0</span>
                <span className="font-mono font-extrabold text-lg text-almost-black">23%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-mono font-bold text-sm uppercase">CHIPS ABOVE 8.0</span>
                <span className="font-mono font-extrabold text-lg text-almost-black">12%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-mono font-bold text-sm uppercase">CHIPS ABOVE 9.0</span>
                <span className="font-mono font-extrabold text-lg text-almost-black">2%</span>
              </div>
            </div>
          </div>
        </div>
